...
public class ParserUtilTest {
    ...
    public void parseIndices_invalidInput_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseIndices("1 a b"));
    }
    ...
    public void parseIndices_validInput_success() throws Exception {
        // No whitespaces
        assertEquals(INDICES_THREE_PERSONS, ParserUtil.parseIndices("3 2 1"));

        // Leading and trailing whitespaces, with extra whitespaces between numbers
        assertEquals(INDICES_THREE_PERSONS, ParserUtil.parseIndices("  3 2  1 "));
    }
    ...
    public void parseKeywords_multipleValidPrefixKeywords_returnsKeywordSet() throws Exception {
        Set<KeywordMatch> actualKeywordSet = ParserUtil.parseKeywords(
                "A% Rac%", PREFIX_NAME);
        Set<KeywordMatch> expectedKeywordSet = Set.of(
                new KeywordMatch("A%", false),
                new KeywordMatch("Rac%", false));
        assertEquals(expectedKeywordSet, actualKeywordSet);
    }
