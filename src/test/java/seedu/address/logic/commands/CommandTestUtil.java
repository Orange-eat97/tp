...
public class CommandTestUtil {
    ...
    public static final String VALID_REGION_AMY = "Woodlands";
    ...
    public static final String INVALID_REGION_DESC = " " + PREFIX_REGION + "Home"; // Must be a valid Singapore region
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
                ...
                .withTags(VALID_TAG_BENEFICIARY).build();
     ...
     * - the address book, displayed person list and selected person in {@code actualModel} remain unchanged
     */
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        // we are unable to defensively copy the model for comparison later, so we can
        // only do so by copying its components.
        AddressBook expectedAddressBook = new AddressBook(actualModel.getAddressBook());
        List<Person> expectedDisplayedList = new ArrayList<>(actualModel.getDisplayList());

        assertThrows(CommandException.class, expectedMessage, () -> command.execute(actualModel));
        assertEquals(expectedAddressBook, actualModel.getAddressBook());
        assertEquals(expectedDisplayedList, actualModel.getDisplayList());
    }
    /**
     * Updates {@code model}'s display list to show only the person at the given {@code targetIndex} in the
